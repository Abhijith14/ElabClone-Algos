...
$conn = pg_connect("host=$host dbname=$dbname user=$user password=$pass port=$port")
  ...
  $result = pg_query($conn, $sqldata) or die("Cannot execute query: $query\n");
  ...
  $resulttest = pg_query($conn, $sqltest) or die("Cannot execute query: $query\n");
  if (pg_num_rows($resulttest) > 0) {
    $i = 0;
    while ($rowtest = pg_fetch_assoc($resulttest)) {
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav nav ml-auto">
            <li class="nav-item"><a href="java.php" class="nav-link"><span style="color: black;">Home</span></a></li>
 ...
 <div _ngcontent-c16="" class="container ng-star-inserted">
    ...
    <div _ngcontent-c16="" class="solution" >
      <mat-card _ngcontent-c16="" class="mat-elevation-z2 mat-card" style="display: block">
        <h4 _ngcontent-c16="">JAVA CODE</h4>
        <mat-divider _ngcontent-c16="" class="mat-divider" role="separator" aria-orientation="horizontal"></mat-divider>
        <br _ngcontent-c16="">
